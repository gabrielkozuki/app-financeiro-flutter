...
que o modelo de política genérica sugere. As *nutrition labels* do App Store Connect são
preenchidas à parte e **precisam bater** com este texto; divergência entre os dois é motivo de
rejeição.
